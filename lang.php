...
$lang = array(
	...
	'__defart_post_plural'			=> "{!#[1:post][?:posts]} in a topic",
	'__defart_topic'				=> "topic",
	'__defart_topic_plural'			=> "{!#[1:topic][?:topics]}",
	'__defart_answer'				=> "answer to a question",
	'__defart_answer_plural'		=> "{!#[1:answer][?:answers]} to a question",
	'__defart_question'				=> "question",
	'__defart_question_plural'		=> "{!#[1:question][?:questions]}",
	...
	'menu__forums_stats_topics'		=> "Topics",
	'menu__forums_stats_posts'		=> "Posts",
	'menu__forums_stats_solved'     => "Solved",
	...
	'r__topics_manage'				=> "Can view statistics about topics",
	'r__posts'						=> "New Post Statistics",
	'r__posts_manage'				=> "Can view statistics about posts",
	...
	'can_future_publish_topic'		=> "Can set a future publishing date?",
	'can_view_future_topic'			=> "Can view pending publishing items authored by other members?",
	...
	'bw_fluid_view'					=> "Enable Combined Fluid View?",
	'bw_fluid_view_desc'			=> "When enabled, all topics from this forum and any child forums will be shown in a single list with a filter box to allow your members to filter out of specific child forums",
	'bw_fluid_view__warning'		=> "Combined fluid view cannot be enabled as this forum does not have any sub-forums",
	'combined_fluid_view'			=> "Combined Fluid View",
	...
	'forum_use_feature_color_desc'	=> "A feature color will be used in various places such as the forum/category title, forum badges and the forum index.",
	...
	'bw_enable_answers_moderator_desc' => "Moderators (and optionally topic starters) can mark posts as the solution.",
	...
	'solved_stats_from_cutoff'		=> "Statistics Cutoff",
	'solved_stats_from_cutoff_desc' => "Any topics marked as solved that were posted older than the timeframe configured here will be excluded from <a href='{internal.app=forums&module=stats&controller=solved&tab=time}' target='_blank'>Time to Solved</a> statistics for this forum. Note that statistics are built once daily, so changes here may not take effect immediately.",
	
	'rebuilding_starter_ids'		=> "Rebuilding topic starter IDs",
	'chart_forums'					=> "Filter by forums",
	...
	'archiving_blurb_cloud_notforced' => "Archiving older <strong>non-pinned</strong> and <strong>non-featured</strong> topics on larger sites helps keep your community running smoothly. Archived topics cannot be posted in or edited, and will not show in search results. When your community reaches a certain size, archiving of older topics will be required.",
	'disable_cloud_archiving'		=> "Disable archiving",
	...
	'topic_posted_in_groups'		=> "Posts by %s",
	'filter_hidden_topics'			=> "Hidden Topics",
	'filter_hidden_posts_in_topics' => "Topics With Hidden Posts",
	'moderation_log' => "Moderation History",
	'cookie_forumpass_*_description' => "These cookies are used to track authentication for password protected forums. There may be multiple cookies with similar names where * is replaced with the forum ID.",
	...
	'modlog__removed_archive_exclude_topic'	=> "Removed 'exclude from archive' state from topic: <a href='%s'>%s</a>",
	'modlog__saved_action'			=> "Ran a saved action on topic",
	'modlog__unarchived_topic'		=> "Unarchived a topic",
	'modlog__removed_archive_exclude_topic'	=> "Removed 'exclude from archive' state from a topic",
	...
	/* !Statistics */
	'stats_new_topics'	=> "Topics",
	'stats_new_posts'	=> "New Posts",
	
	'stats_topics_tab_total'	=> "All New Topics",
	'stats_topics_tab_byforum'	=> "New Topics By Forum",
	'stats_topics_tab_noposts'	=> "Topics With No Posts",
	'stats_topics_tab_solved'	=> "Solved Topics By Forum",
	'stats_topics_title_solved' => "Solved Topics By Forum",
	'stats_topics_tab_groups'	=> "Solved Topics By Group",
	'stats_topics_title'	=> "New topics by time period",
	'stats_topics_title_byforum'	=> "New topics by forum",
	'stats_new_posts'	=> "Posts",
	'stats_topics_tab_unsolved' => "Unsolved Topics",
	
	'topics_noposts_tid'	=> "Topic ID",
	'topics_noposts_title'	=> "Title",
	'topics_noposts_state'	=> "Status",
	'topics_noposts_start_date' => "Started",
	'topics_noposts_starter_id' => "Author",
	'topics_noposts_views'		=> "Views",
	'topics_noposts_forum_id'	=> "Forum",
	'topics_noposts_approved'	=> "Approved",
	
	'stats_topics_tab_total'	=> "All Topics",
	'stats_topics_tab_byforum'	=> "Topics By Forum",
	'stats_topics_title'	=> "Topics by time period",
	'stats_topics_title_byforum'	=> "Topics by forum",

	'stats_posts_tab_total'	=> "All Posts",
	'stats_posts_tab_byforum'	=> "Posts By Forum",
	'stats_posts_title'		=> "Posts by time period",
	'stats_posts_title_byforum'	=> "Posts by forum",

	'stats_percentagesolved'		=> "Percentage Solved",
	'stats_percentagesolved_desc'	=> "The percent of topics solved compared to the total number of topics posted",
	'stats_solved_tooltip'			=> "%s topics were marked solved out of %s total topics",
	'stats_solved_tooltip_prev'		=> "%s topics were marked solved out of %s total topics for a solution rate of %s%%",
	'stats_averagetimesolved'		=> "Average Time To Solution",
	'stats_averagetimesolved_desc'	=> "The average amount of time that passed between the time the topic was started and the time a solution was marked",
	
	'menu__forums_stats_questions'	=> "Questions",
	'stats_question_ratings_title'	=> "Question up/down votes over time",
	'stats_question_ratings_negative'	=> "Downvote",
	'stats_question_ratings_positive'	=> "Upvote",
	'r__questions'						=> "Questions",
	'r__questions_manage'				=> "Can view question statistics?",
	
	'menu__forums_stats_solvers'		=> "Top Solvers",
	'top_solvers'						=> "Top Solvers",
	'top_solvers_name'					=> "Username",
	'top_solvers_count'					=> "Solved Count",
	'top_solvers_solved_date'			=> "Date Range",
	'top_solvers_date'		=> "Last Solution Date",
	'top_solvers_member_group_id'		=> "Group",
	...
	'forums_solved_topic_reengage' => "Email author to mark a reply as a solution",
	'forums_solved_topic_reengage_prefix' => "if the topic is not solved and the topic was started",
	'forums_solved_topic_reengage_suffix' => "days ago or more",
	'forums_solved_topic_reengage_never' => "never email the author to ask",
	'forums_solved_stats_time'			 => "Time To Solved (in days)",
	'forums_solved_stats_percentage'	 => "Percentage Solved",
	'solved_stats_rebuild_started' => 'Statistics rebuild started',
	'solved_stats_rebuild_button'		=> "Rebuild Solved Statistics",
	'solved_rebuilding_stats' => "Rebuilding solved statistics for forum %s",
	'solved_stats_chart_desc' => "The data in this chart updates once per day.",
	...
	'forums_topic_show_meta_moderation_desc' => "You can specify which groups can see moderation events in the <a href='{internal.app=core&module=members&controller=groups}'>Group Settings</a>",

	'forums_mod_actions_anon'	=> "Show moderator name alongside moderation events",
	'forums_mod_actions_anon_desc'	=> "If disabled, the name of the moderator who performed the action will be hidden from other users who do not have permission to moderate within the forum.",
  
  /* !Error messages */
  	'404_forums_topic' => "We could not find that topic.",
	'403_forums_topic' => "You do not have permission to view this topic.",  
  ...
  /* !Mobile App */
	...
	/* !Achievements */
	'AchievementAction__AnswerMarkedBest' 				=> "Post is marked as the best answer",
	'achievement_filter_AnswerMarkedBest_forum'			=> "Add a location condition",
	'achievement_filter_AnswerMarkedBest_forum_prefix'	=> "The question is in the forum",
	'achievement_filter_AnswerMarkedBest_poster'		=> "To the user who posted the answer",
	'achievement_filter_AnswerMarkedBest_asker'			=> "To the user who posted the original question",
	'achievement_filter_AnswerMarkedBest_nth'			=> "Add a milestone condition",
	'achievement_filter_AnswerMarkedBest_nth_suffix'	=> "th time having a post in that forum marked as the best answer",
	'AchievementAction__AnswerMarkedBest_log_subject'	=> "Answer given to %s marked as the best answer",
	'AchievementAction__AnswerMarkedBest_log_other'		=> "Question %s had an answer marked as the best answer",
	'AchievementAction__AnswerMarkedBest_log_deleted'	=> "a deleted question",
	'AchievementAction__AnswerMarkedBest_title'			=> "Best answer",
);
